...
class ApplicationTests(unittest.TestCase):
    ...
    def test_static_assets_contain_required_interactions(self) -> None:
        ...
        self.assertIn('/static/graph-renderer.js', html)
        self.assertIn('aria-activedescendant="graph-keyboard-node"', html)
        self.assertNotIn('<svg id="graph"', html)
        ...
        self.assertIn("openNode(hit.id)", javascript)
